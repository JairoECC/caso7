...
# Theme.css
Por esta parte hicimos cambios en el **theme.css** y estamos tomando como ejemplo Microsoft Azure.
Cambiamos el color de los botones, colocamos hovers que se usan en Microsoft cambiamos el border radius de los contenedores y más.
...
@media only screen and (min-width: 768px) {
    ...
    html.sidebar-right-opened.has-top-menu:not(.has-left-sidebar-half)
        .inner-wrapper {
        margin-left: 0;
        padding-right: 300px;
    }
...
@media only screen and (min-width: 768px) {
    ...
    html.fixed.header-floating .page-header,
    html.fixed.header-static .page-header {
        position: static;
    }
    html.fixed.header-hidden .page-header {
        top: 0;
    }
    .header-floating #main-wrapper,
    .header-static #main-wrapper,
    .header-hidden #main-wrapper {
        padding: 0;
    }
    .header-floating #main-wrapper > div > .card,
    .header-static #main-wrapper > div > .card,
    .header-hidden #main-wrapper > div > .card {
        margin: 40px;
    }
    html.fixed.header-static .inner-wrapper {
        padding-top: 0;
    }
    html.fixed.header-hidden .inner-wrapper {
        padding-top: 50px;
    }
...
@media only screen and (min-width: 768px) {
    /* Layout Boxed - Content Body */
    html.boxed:not(.sidebar-left-big-icons):not(.has-top-menu):not(.has-tab-navigation):not(.left-sidebar-panel).sidebar-left-collapsed
        .content-body {
        width: calc(100% - 73px);
    }

    html.boxed:not(.sidebar-left-big-icons):not(.has-top-menu):not(.has-tab-navigation):not(.left-sidebar-panel).left-sidebar-panel
        .content-body {
        width: calc(100% - 375px);
    }

    html.boxed:not(.sidebar-left-big-icons):not(.has-top-menu):not(.has-tab-navigation):not(.left-sidebar-panel).left-sidebar-panel.sidebar-right-opened
        .content-body {
...
.header .logo-container .topbar-links i {
    font-size: 12px;
    margin: 3px 0;
}
.header .logo-container .topbar-links:hover {
...
.header .logo-container .topbar-links:last-of-type {
    margin-right: auto;
}
...
@media only screen and (min-width: 768px) {
    ...
    html.sidebar-left-sm.sidebar-left-collapsed.fixed
        .sidebar-left
        .nano:hover {
        width: 250px;
    }
...
@media only screen and (min-width: 768px) {
    ...
    html.sidebar-left-xs.sidebar-left-collapsed.fixed
        .sidebar-left
        .nano:hover {
        width: 200px;
    }
...
.dark .sidebar-left .sidebar-header {
    background-color: #283046;
}
...
html.dark .sidebar-toggle {
    border-right: 1px solid #161d31;
}
html.header-dark .sidebar-toggle {
    border-right: 1px solid #161d31;
}
...
@media only screen and (min-width: 768px) {
    ...
    html.sidebar-left-big-icons.sidebar-light
        ...
        > a {
        background: #fafafa;
        box-shadow: 2px 0 0 #2446e8 inset;
    ...
    html.sidebar-left-big-icons.sidebar-light.sidebar-left-with-menu:not(.sidebar-right-opened)
        .inner-menu {
        border-left: 2px solid #e2e3e6;
    }

    html.sidebar-left-big-icons.sidebar-light.sidebar-left-with-menu.no-overflowscrolling:not(.dark)
        .inner-menu
        .nano {
        -webkit-box-shadow: none;
        box-shadow: none;
    ...
    html.sidebar-left-big-icons.sidebar-left-with-menu:not(.sidebar-right-opened):not(.scroll)
        .inner-body {
        margin-left: 153px;
    }
    ...
    html.sidebar-left-big-icons.sidebar-left-with-menu.sidebar-left-collapsed:not(.sidebar-right-opened):not(.scroll)
        .content-body {
        margin-left: 55px;
    }
    ...
    html.sidebar-left-big-icons.sidebar-left-with-menu.sidebar-left-collapsed:not(.scroll)
        .inner-body {
        margin-left: 300px;
    }

    html.sidebar-left-big-icons.sidebar-left-with-menu.scroll
        .content-with-menu {
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
...
@media only screen and (min-width: 768px) and (max-width: 1365px) {
    ...
    html.sidebar-left-big-icons.sidebar-left-with-menu.sidebar-left-collapsed.inner-menu-opened:not(.sidebar-right-opened):not(.scroll)
        .content-body {
        margin-left: 355px;
    }
    ...
    html.sidebar-left-big-icons.sidebar-left-with-menu.inner-menu-opened:not(.sidebar-right-opened):not(.scroll)
        .content-body {
        margin-left: 300px;
    }
...
@media (min-width: 992px) {
    ...
    .tab-navigation nav > ul > li > a .fab,
    .tab-navigation nav > ul > li > a .fal,
    .tab-navigation nav > ul > li > a .far,
    .tab-navigation nav > ul > li > a .fas {
        font-size: 14px;
        margin-right: 7px;
        position: relative;
        top: 1px;
...
@media (max-width: 991px) {
    ...
    .tab-navigation nav > ul > li .fab,
    .tab-navigation nav > ul > li .fal,
    .tab-navigation nav > ul > li .far,
    .tab-navigation nav > ul > li .fas {
        margin-right: 10px;
    }
...
@media (max-width: 991px) {
    ...
    .header-nav-main nav > ul > li.active > a:focus,
...
@media (min-width: 992px) {
    ...
    .header-nav-main nav > ul > li.show > a,
    ...
    .header-nav-main nav > ul > li.dropdown.show > a,
    .header-nav-main nav > ul > li.dropdown:hover > a {
        padding-bottom: 15px;
    }

    .header-nav-main nav > ul > li.dropdown.show > .dropdown-menu,
    ...
    .header-nav.header-nav-dark-dropdown nav > ul > li > a,
    .header-nav.header-nav-dark-dropdown nav > ul > li:hover > a {
        background: transparent;
        color: #444;
...
@media (min-width: 992px) {
    ...
    .header-nav-main.header-nav-main-light nav > ul > li.show > a,
    .header-nav-main.header-nav-main-light nav > ul > li:hover > a {
        background: #fff;
    }
    ...
    .header-nav-main.header-nav-main-light nav > ul > li.show > .dropdown-menu,
    .header-nav-main.header-nav-main-light
        nav
        > ul
        > li:hover
...
.btn-primary {
    ...
    border-color: #2446e8 #2446e8 #006699;
    color: #fff;
}
...
.ios-switch .handle {
    ...
    position: absolute;
    border-radius: 20px;
    -webkit-box-shadow: 0 0 3px 1px rgba(0, 0, 0, 0.075),
        0 3px 5px rgba(0, 0, 0, 0.15), 1px 2px 2px rgba(0, 0, 0, 0.05);
    ...
    transition: transform 0.3s 0.25s cubic-bezier(0.455, 0.03, 0.215, 1.33),
        -webkit-transform 0.3s 0.25s cubic-bezier(0.455, 0.03, 0.215, 1.33);
    -webkit-box-sizing: content-box;
    box-sizing: content-box;
}
...
.bounce-loader .bounce3 {
    -webkit-animation: 1.4s ease-in-out 0s normal both infinite running
        bouncedelay;
...
.notifications > li .notification-icon:hover {
    text-decoration: none;
}
...
.progress.light {
    ...
    background-image: -webkit-gradient(
        ...
        left bottom,
        from(#f6f7f8),
        color-stop(10%, #f6f7f8),
        color-stop(11%, #f5f5f5)
    );
...
.mailbox-compose .mailbox-compose-field .bootstrap-tagsinput,
.mailbox-compose .mailbox-compose-field .form-control {
    padding-left: 120px;
}
...
ul.nav-main li.nav-expanded > a::before {
    border: 1px solid #565360;
}
...
html:not(.sidebar-light) ul.nav-main li.nav-expanded > a {
...
.sidebar-blue ul.nav-main li.nav-active:not(.nav-parent) > a,
.sidebar-blue ul.nav-main li .nav-children li.nav-active:not(.nav-parent) > a {
    background: #909399;
    color: #fff !important;
    box-shadow: 0 0 10px 1px rgb(115 103 240 / 70%);
    border-radius: 4px !important;
...
.sidebar-left-collapsed .sidebar-left .sidebar-header .logo img {
    height: auto;
    width: 100%;
}
.dark .nano {
...
html.dark ul.nav-main li a::before {
    border: 1px solid #d0d2d6;
}
html.dark ul.nav-main li.nav-expanded > a::before {
    background: #d0d2d6;
}
...
html.dark ul.nav-main li.nav-expanded > a::after,
html.dark ul.nav-main li a:hover::after {
    color: #d0d2d6 !important;
}
...
/* fondo dark */
html.fixed.sidebar-dark .sidebar-left,
html.fixed.sidebar-dark .sidebar-header,
html.fixed.sidebar-dark .sidebar-left .nano {
    background-color: #283046 !important;
}
html.fixed.sidebar-dark .sidebar-left a {
    color: #d0d2d6;
}
html.fixed.sidebar-dark ul.nav-main li a:hover,
html.fixed.sidebar-dark ul.nav-main li .nav-children li a:focus {
    background-color: transparent;
}
html.fixed.sidebar-dark .sidebar-left a::before,
html.fixed.sidebar-dark .sidebar-left a::after,
html.fixed.sidebar-dark .sidebar-left a:hover::before,
html.fixed.sidebar-dark .sidebar-left a:active::before,
html.fixed.sidebar-dark .sidebar-left a:focus::before,
html.fixed.sidebar-dark .sidebar-left a:hover::after,
html.fixed.sidebar-dark .sidebar-left a:active::after,
html.fixed.sidebar-dark .sidebar-left a:focus::after {
    color: #fff;
    border-color: #fff;
}
/* Superadmin */
...
html.sidebar-left-big-icons .sidebar-left .sidebar-header .sidebar-title {
...
.btn-demo.btn-demo-prod {
    position: relative;
    color: #6c757d;
}
.btn-demo.btn-demo-prod::before {
    content: "";
    position: absolute;
    left: 0;
    top: 50%;
...
html.dark ul.nav-main li.nav-description{
    color: #d0d2d6;
}
.fa-angle-left{
    color: #fff;
